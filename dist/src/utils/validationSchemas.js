...
exports.createEventSchema = joi_1.default.object({
    ...
    bringInstrument: joi_1.default.boolean()
        .required()
        .messages({
...
exports.createPaymentMethodSchema = joi_1.default.object({
    ...
    billingAddress: joi_1.default.object({
        ...
        postalCode: joi_1.default.string().pattern(/^\d{5}(-\d{4})?$/).required(),
...
exports.searchEventsSchema = joi_1.default.object({
    ...
    dateTo: joi_1.default.date()
        .greater(joi_1.default.ref('dateFrom'))
        .optional()
        .messages({
