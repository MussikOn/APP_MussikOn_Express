...
const requestEmailVerificationController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, lastName, userEmail, userPassword, roll } = req.body;
        console.log('[src/controllers/authController.ts:356] Solicitud de verificación recibida:', { name, lastName, userEmail, roll });
        ...
        const existingUser = yield (0, authModel_1.getUserByEmailModel)(userEmail);
        if (existingUser) {
...
const verifyAndCompleteRegistrationController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userEmail, code } = req.body;
        console.log('[src/controllers/authController.ts:450] Verificación de código recibida:', { userEmail, code });
        // Validar campos requeridos
        if (!userEmail || !code) {
            return res.status(400).json({
                success: false,
        ...
        const result = yield (0, authModel_1.registerModel)(name, lastName, roll, userEmail, userPassword, true);
        if (result === false) {
