 ...
 */
export const getEventAnalyticsController = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getRequestAnalyticsController = asyncHandler(async (req: Request, res: Response) => {
  const filters: AnalyticsFilters = {
    dateFrom: req.query.dateFrom as string,
    dateTo: req.query.dateTo as string,
    eventType: req.query.eventType as string,
 ...
 */
export const getUserAnalyticsController = asyncHandler(async (req: Request, res: Response) => {
  const filters: AnalyticsFilters = {
    dateFrom: req.query.dateFrom as string,
    dateTo: req.query.dateTo as string,
 ...
 */
export const getPlatformAnalyticsController = asyncHandler(async (req: Request, res: Response) => {
  const filters: AnalyticsFilters = {
    dateFrom: req.query.dateFrom as string,
    dateTo: req.query.dateTo as string,
    eventType: req.query.eventType as string,
 ...
 */
export const getTrendsReportController = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getLocationPerformanceReportController = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getTopActiveUsersReportController = asyncHandler(async (req: Request, res: Response) => {
...
export const getDashboardController = asyncHandler(async (req: Request, res: Response) => {
  ...
  const [eventAnalytics, requestAnalytics, userAnalytics, platformAnalytics, trends] = await Promise.all([
