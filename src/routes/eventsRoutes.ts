...
import {
  ...
  getEventWithAdvancedInfoController,
  musicianHeartbeatController,
 ...
 *         description: Error al obtener el evento
 */
router.get('/advanced/:eventId', authMiddleware, getEventWithAdvancedInfoController);
 ...
 */
router.post('/heartbeat', authMiddleware, musicianHeartbeatController);
