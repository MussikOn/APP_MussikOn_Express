...
export const createPaymentMethodController = asyncHandler(async (req: Request, res: Response) => {
...
export const getPaymentMethodsController = asyncHandler(async (req: Request, res: Response) => {
  const { userId } = req.user!;
...
export const setDefaultPaymentMethodController = asyncHandler(async (req: Request, res: Response) => {
  const { userId } = req.user!;
  const { paymentMethodId } = req.params;

  logger.info('Setting default payment method', { userId, metadata: { paymentMethodId } });
...
export const createPaymentIntentController = asyncHandler(async (req: Request, res: Response) => {
  ...
  logger.info('Creating payment intent', { userId, metadata: { amount, currency } });
...
export const processPaymentController = asyncHandler(async (req: Request, res: Response) => {
  ...
  logger.info('Processing payment', { userId, metadata: { paymentIntentId, paymentMethodId } });
...
export const createInvoiceController = asyncHandler(async (req: Request, res: Response) => {
  ...
  logger.info('Creating invoice', { userId, metadata: { itemsCount: items.length } });
...
export const getInvoicesController = asyncHandler(async (req: Request, res: Response) => {
  const { userId } = req.user!;
  const { status } = req.query;

  logger.info('Getting invoices', { userId, metadata: { status: status as string } });
...
export const markInvoiceAsPaidController = asyncHandler(async (req: Request, res: Response) => {
  const { userId } = req.user!;
  const { invoiceId } = req.params;
  const { paymentMethodId } = req.body;

  logger.info('Marking invoice as paid', { userId, metadata: { invoiceId, paymentMethodId } });

  const result = await paymentService.markInvoiceAsPaid(invoiceId, paymentMethodId);
...
// Procesar reembolso
export const processRefundController = asyncHandler(async (req: Request, res: Response) => {
  const { userId } = req.user!;
  const { paymentIntentId, amount, reason } = req.body;

  logger.info('Processing refund', { userId, metadata: { paymentIntentId, amount, reason } });
...
export const getPaymentStatsController = asyncHandler(async (req: Request, res: Response) => {
...
export const validatePaymentMethodController = asyncHandler(async (req: Request, res: Response) => {
...
export const getPaymentGatewaysController = asyncHandler(async (req: Request, res: Response) => {
