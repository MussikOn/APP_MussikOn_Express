...
const ratingRoutes_1 = __importDefault(require("./src/routes/ratingRoutes"));
const depositRoutes_1 = __importDefault(require("./src/routes/depositRoutes"));
// Importar gestor de índices
const firestoreIndexes_1 = require("./src/utils/firestoreIndexes");
const eventSocket_1 = require("./src/sockets/eventSocket");
...
app.use('/deposits', depositRoutes_1.default);
...
io.on('connection', (socket) => {
    ...
    (0, eventSocket_1.socketHandler)(io, socket, {});
});
