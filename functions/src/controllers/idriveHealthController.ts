...
export class IDriveHealthController {
  ...
  async getHealthStatus(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Solicitando estado de salud de IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error obteniendo estado de salud:', error instanceof Error ? error : new Error(String(error)));
  ...
  async forceHealthCheck(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Forzando verificación de salud de IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error en verificación forzada:', error instanceof Error ? error : new Error(String(error)));
  ...
  async checkTokenIssues(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Verificando problemas de tokens de IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error verificando problemas de tokens:', error instanceof Error ? error : new Error(String(error)));
  ...
  async generateHealthReport(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Generando reporte de salud de IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error generando reporte de salud:', error instanceof Error ? error : new Error(String(error)));
  ...
  async getUsageStats(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Obteniendo estadísticas de uso de IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error obteniendo estadísticas:', error instanceof Error ? error : new Error(String(error)));
  ...
  async restartConnection(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Reiniciando conexión con IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error reiniciando conexión:', error instanceof Error ? error : new Error(String(error)));
  ...
  async getConfigurationInfo(req: Request, res: Response): Promise<void> {
    try {
      logger.info('[functions/src/controllers/idriveHealthController.ts] Obteniendo información de configuración de IDrive E2');
      ...
      logger.error('[functions/src/controllers/idriveHealthController.ts] Error obteniendo configuración:', error instanceof Error ? error : new Error(String(error)));
