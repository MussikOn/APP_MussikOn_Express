...
export const savePushSubscription = asyncHandler(async (req: Request, res: Response) => {
  ...
  const subscription = await pushNotificationService.saveSubscription(userId, {
    endpoint,
    keys,
    isActive: true
  });
 ...
 */
export const getUserPushSubscriptions = asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user?.userId;
 ...
 */
export const createNotificationTemplate = asyncHandler(async (req: Request, res: Response) => {
...
export const getNotificationTemplate = asyncHandler(async (req: Request, res: Response) => {
  ...
  const template = await pushNotificationService.getNotificationTemplate(templateId);
 ...
 */
export const getActiveTemplates = asyncHandler(async (req: Request, res: Response) => {
...
export const updateNotificationTemplate = asyncHandler(async (req: Request, res: Response) => {
  ...
  const updatedTemplate = await pushNotificationService.updateNotificationTemplate(templateId, updates);
 ...
 */
export const deleteNotificationTemplate = asyncHandler(async (req: Request, res: Response) => {
  const { templateId } = req.params;
